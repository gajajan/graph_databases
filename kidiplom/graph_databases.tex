...
Úvod do grafových databází, co to je.

\subsection{Výhody grafových databází}
Pojednává o výhodách grafových databází. Jsou vhodné pro data, které jsou hustě propojené. Nejznáměší příklad takových dat jsou data ze sociální sítě.
Sociální sítě často poskytují nabízení nových přátel, lidí se kterými by se uživatel chtěl spojit. Jedním ze způsbů je navrhování přátel, kteří již jsou přátelé uživatelových přátel. Další příklad, kde je vhodné použít "grafový" přístup jsou například mapy... 

\subsection{Nevýhody grafových databází}
Nevýhody grafových databázích se projeví například, když bychom data agregovali, chtěli zjistit počet uzlů, sumaci dat...
