...
Grafy se dělí na orientované a neorientované. Hranu v neorientovaném grafu mezi vrcholy u a v nazýváme neorientovanou a zapisujeme pomocí množiny obsahující dvojici vrcholů, tedy {u, v}. V případě orientovaného grafu hranu nazýváme orientovanou a pro zápis používáme uspořádanou dvojici, tedy (u, v). Grafy nejčastěji znázorňujeme pomocí kroužků, které představují vrcholy, a úseček mezi nimi, sloužící pro reprezentaci hran. Pokud se jedná o orientovaný graf místo úseček používáme šipky. Pro hrany používáme označení násobné, pokud existuje mezi dvěma vrcholy hran více. O hraně začínající i končící ve stejném vrcholu mluvíme jako o smyčce.  
...
Je sekvence vrcholů. Cesta délky n má $n+1$ vrcholů.
\end{definition}

\begin{definition}[Vzdálenost]
Vzdálenost z vrcholu u do vrcholu v můžeme definovat jako délku nejkratší cesty z u do v.
\end{definition}
