...
Grafové databáze jsou vhodné pro data, které jsou hustě propojené. Relace a vztahy mezi entitami jsou zde stejně důležité, ne-li důležitější, než samotné entity. Nejznáměším příkladem takových dat jsou data ze sociálních sítí.
