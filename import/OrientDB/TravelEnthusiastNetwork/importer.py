...
IMPORT_DIR = r"C:\Users\gajaj\Desktop\School\Bachelor\graph_databases\import\OrientDB\TravelEnthusiastNetwork"
...
vertex_file_names = ["journeys", "ratings"]

edge_file_names = ["led_to", "participated", "wrote_about"]
